          ...
          <table class="w-full mb-4">
            <tbody>
                <tr class="text-left text-gray-700">
                    <th class="font-normal p-5 pt-0">Tanggal</th>
                    <th class="font-normal pb-5 pt-0">ID Transaksi</th>
                    <th class="font-normal pb-5 pt-0">Nominal</th>
                    <th class="font-normal pb-5 pt-0">Metode</th>
                    <th class="font-normal pb-5 pt-0">Jenis</th>
                    <th class="font-normal pb-5 pt-0">Status</th>
                    <th class="font-normal pb-5 pt-0 justify-end"></th>
                </tr>
                <tr class="font-bold text-gray-800 mb-5">
                    <td class="p-5 text-gray-500 bg-white rounded-l-lg">17 JANUARI 2021</td>
                    <td class="bg-white">TWL2277972</td>
                    <td class="bg-white">RP 80.000</td>
                    <td class="bg-white">-</td>
                    <td class="bg-white">PENARIKAN</td>
                    <td class="bg-white"><p class="text-sm bg-primaryDisable text-primary py-2 px-3 rounded-lg w-max">PEMBAYARAN</p></td>
                    <td class="bg-white rounded-r-lg justify-end flex p-3">
                      <button class="p-2 w-12 h-12 text-gray-700" id="settings">
                      <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 12h.01M12 12h.01M19 12h.01M6 12a1 1 0 11-2 0 1 1 0 012 0zm7 0a1 1 0 11-2 0 1 1 0 012 0zm7 0a1 1 0 11-2 0 1 1 0 012 0z"></path></svg>
                      </button>
                      <div id="settings-dropdown" class="hidden origin-top-right absolute right-0 mt-10 mr-24 w-56 rounded-lg shadow-lg bg-white ring-1 ring-black ring-opacity-5">
                        <div class="py-1" role="menu" aria-orientation="vertical" aria-labelledby="options-menu">
                        <a href="#/profile" class="block px-4 py-3 text-sm font-normal text-gray-700 hover:bg-gray-100 hover:text-gray-900" role="menuitem">Edit Profil</a>
                        </div>
                      </div>
                    </td>
                </tr>
                <tr class="font-bold text-gray-800 mb-5 border-b">
                    <td class="p-5 text-gray-500 bg-white rounded-l-lg">17 JANUARI 2021</td>
                    <td class="bg-white">TWL2277972</td>
                    <td class="bg-white">RP 80.000</td>
                    <td class="bg-white">-</td>
