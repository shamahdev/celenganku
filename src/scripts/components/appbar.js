...
class Appbar extends HTMLElement {
  ...
  _renderLinksByRole() {
    ...
    if (role === 'user') {
      // Admin navs
      links = /* html */`
        <a href="#/profile" target="_blank" rel="noopener" atau rel="noreferrer" class="flex px-4 py-3 text-sm font-normal text-gray-700 hover:bg-gray-100 hover:text-gray-900"
          role="menuitem">
        ...
        <a href="https://github.com/shamahdotid/celenganku-app/blob/main/README.md" class="flex px-4 py-3 text-sm font-normal text-gray-700 hover:bg-gray-100 hover:text-gray-900"
          role="menuitem">
          <i class="text-primary flex"><svg class="w-6 h-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      // User/Siswa Navs
      links = /* html */`
      <a href="https://github.com/shamahdotid/celenganku-app/blob/main/README.md" target="_blank" rel="noopener" atau rel="noreferrer" class="flex px-4 py-3 text-sm font-normal text-gray-700 hover:bg-gray-100 hover:text-gray-900"
      role="menuitem">
