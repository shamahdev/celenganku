...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => __WEBPACK_DEFAULT_EXPORT__\n/* harmony export */ });\n/* harmony import */ var firebase_app__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! firebase/app */ \"firebase/app\");\n/* harmony import */ var firebase_app__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(firebase_app__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var _base_controller__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./base-controller */ \"./server/controllers/base-controller.js\");\n/* harmony import */ var _global_firebase__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../global/firebase */ \"./server/global/firebase.js\");\nfunction ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); if (enumerableOnly) symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; }); keys.push.apply(keys, symbols); } return keys; }\n\nfunction _objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; if (i % 2) { ownKeys(Object(source), true).forEach(function (key) { _defineProperty(target, key, source[key]); }); } else if (Object.getOwnPropertyDescriptors) { Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)); } else { ownKeys(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } } return target; }\n\nfunction _defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }\n\nfunction asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }\n\nfunction _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"next\", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"throw\", err); } _next(undefined); }); }; }\n\n/* eslint-disable camelcase */\n\n\n\nvar Transaction = _global_firebase__WEBPACK_IMPORTED_MODULE_2__.db.collection('transaksi');\nvar TransactionController = {\n  getTransactionById: _base_controller__WEBPACK_IMPORTED_MODULE_1__.default.getOne(Transaction),\n  deleteTransactionById: _base_controller__WEBPACK_IMPORTED_MODULE_1__.default.deleteOne(Transaction),\n  getTransactionByNisn: function () {\n    var _getTransactionByNisn = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(req, res, next) {\n      var snapshot, transactionData;\n      return regeneratorRuntime.wrap(function _callee$(_context) {\n        while (1) {\n          switch (_context.prev = _context.next) {\n            case 0:\n              console.log(req.params);\n              _context.prev = 1;\n              _context.next = 4;\n              return Transaction.where('nisn', '==', req.params.id).get();\n\n            case 4:\n              snapshot = _context.sent;\n\n              if (snapshot.empty) {\n                res.status(401).json({\n                  status: 'failed',\n                  error: true,\n                  message: 'No transaction found from that user id',\n                  response: req.params\n                });\n              }\n\n              transactionData = [];\n              snapshot.forEach(function (doc) {\n                transactionData.push(doc.data());\n              });\n              res.status(200).json({\n                status: 'success',\n                error: false,\n                results: transactionData.length,\n                data: transactionData\n              });\n              return _context.abrupt(\"return\", {\n                success: true\n              });\n\n            case 12:\n              _context.prev = 12;\n              _context.t0 = _context[\"catch\"](1);\n              console.log(_context.t0); // res.status(502).json({\n              //   status: 'success',\n              //   error: true,\n              //   response: error,\n              // })\n\n            case 15:\n            case \"end\":\n              return _context.stop();\n          }\n        }\n      }, _callee, null, [[1, 12]]);\n    }));\n\n    function getTransactionByNisn(_x, _x2, _x3) {\n      return _getTransactionByNisn.apply(this, arguments);\n    }\n\n    return getTransactionByNisn;\n  }(),\n  createTransaction: function () {\n    var _createTransaction = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(req, res, next) {\n      var _req$body, nominal, metode_pembayaran, jenis_transaksi, nisn, metodeLetter, jenisLetter, allTransaction, snapshot, allTransactionId, generatedNumber, id_transaksi, dateCreated, time, transactionResponse;\n\n      return regeneratorRuntime.wrap(function _callee2$(_context2) {\n        while (1) {\n          switch (_context2.prev = _context2.next) {\n            case 0:\n              _context2.prev = 0;\n              _req$body = req.body, nominal = _req$body.nominal, metode_pembayaran = _req$body.metode_pembayaran, jenis_transaksi = _req$body.jenis_transaksi, nisn = _req$body.nisn; // Check if req.body is not empty\n\n              if (!(!nominal || !metode_pembayaran || !jenis_transaksi || !nisn)) {\n                _context2.next = 4;\n                break;\n              }\n\n              return _context2.abrupt(\"return\", res.status(404).json({\n                status: 'failed',\n                error: true,\n                message: 'Something wrong when creating a transaction',\n                response: req.body\n              }));\n\n            case 4:\n              metodeLetter = metode_pembayaran[0].toUpperCase();\n              jenisLetter = '';\n              if (jenis_transaksi === 'pemasukan') jenisLetter = 'D';else jenisLetter = 'W';\n              allTransaction = [];\n              _context2.next = 10;\n              return Transaction.get();\n\n            case 10:\n              snapshot = _context2.sent;\n              snapshot.forEach(function (doc) {\n                allTransaction.push(doc.data());\n              });\n              allTransactionId = [];\n              allTransaction.forEach(function (transaction) {\n                allTransactionId.push(transaction.id_transaksi);\n              });\n              generatedNumber = Math.floor(1000000 + Math.random() * 9000000);\n              id_transaksi = \"T\".concat(jenisLetter + metodeLetter + generatedNumber.toString());\n\n              while (allTransactionId.includes(id_transaksi)) {\n                generatedNumber = Math.floor(1000000 + Math.random() * 9000000);\n                id_transaksi = \"T\".concat(jenisLetter + metodeLetter + generatedNumber.toString());\n              }\n\n              dateCreated = new Date();\n              dateCreated.setDate(dateCreated.getDate() + 1);\n              time = firebase_app__WEBPACK_IMPORTED_MODULE_0__.firestore.Timestamp.fromDate(dateCreated);\n              transactionResponse = {\n                id_transaksi: id_transaksi,\n                nominal: nominal,\n                metode_pembayaran: metode_pembayaran,\n                jenis_transaksi: jenis_transaksi,\n                nisn: nisn,\n                status_transaksi: 'pembayaran',\n                tenggat_waktu_pembayaran: time,\n                token: ''\n              };\n              _context2.next = 23;\n              return Transaction.doc(id_transaksi).set(transactionResponse);\n\n            case 23:\n              res.status(200).json({\n                status: 'success',\n                error: false,\n                response: _objectSpread({}, transactionResponse)\n              });\n              _context2.next = 30;\n              break;\n\n            case 26:\n              _context2.prev = 26;\n              _context2.t0 = _context2[\"catch\"](0);\n              console.log(_context2.t0);\n              res.status(502).json({\n                status: 'failed',\n                error: true,\n                response: _context2.t0\n              });\n\n            case 30:\n            case \"end\":\n              return _context2.stop();\n          }\n        }\n      }, _callee2, null, [[0, 26]]);\n    }));\n\n    function createTransaction(_x4, _x5, _x6) {\n      return _createTransaction.apply(this, arguments);\n    }\n\n    return createTransaction;\n  }(),\n  updateTransaction: function () {\n    var _updateTransaction = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(req, res, next) {\n      var _req$body2, token, status_transaksi, id_transaksi, transaction, transactionData, updateData;\n\n      return regeneratorRuntime.wrap(function _callee3$(_context3) {\n        while (1) {\n          switch (_context3.prev = _context3.next) {\n            case 0:\n              _context3.prev = 0;\n              _req$body2 = req.body, token = _req$body2.token, status_transaksi = _req$body2.status_transaksi;\n              id_transaksi = req.params.id;\n              _context3.next = 5;\n              return Transaction.doc(id_transaksi).get();\n\n            case 5:\n              transaction = _context3.sent;\n\n              if (!transaction.exists) {\n                res.status(401).json({\n                  status: 'failed',\n                  error: true,\n                  message: 'Transaction with this ID doesn\\'t exist',\n                  response: req.body\n                });\n              }\n\n              transactionData = transaction.data();\n              updateData = {\n                status_transaksi: status_transaksi || transactionData.status_transaksi,\n                token: token || transactionData.token\n              }; // Check for existed document\n\n              _context3.next = 11;\n              return Transaction.doc(id_transaksi).update({\n                status_transaksi: updateData.status_transaksi,\n                token: updateData.token\n              });\n\n            case 11:\n              res.status(200).json({\n                status: 'success',\n                error: false,\n                response: req.body\n              });\n              return _context3.abrupt(\"return\", {\n                success: true\n              });\n\n            case 15:\n              _context3.prev = 15;\n              _context3.t0 = _context3[\"catch\"](0);\n              console.log(_context3.t0);\n              res.status(502).json({\n                status: 'failed',\n                error: true,\n                response: _context3.t0\n              });\n\n            case 19:\n            case \"end\":\n              return _context3.stop();\n          }\n        }\n      }, _callee3, null, [[0, 15]]);\n    }));\n\n    function updateTransaction(_x7, _x8, _x9) {\n      return _updateTransaction.apply(this, arguments);\n    }\n\n    return updateTransaction;\n  }()\n};\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (TransactionController);\n\n//# sourceURL=webpack://celenganku-app/./server/controllers/transaction-controller.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => __WEBPACK_DEFAULT_EXPORT__\n/* harmony export */ });\nvar CONFIG = {\n  PORT: process.env.PORT || 8080,\n  DIST_DIR: __dirname,\n  MIDTRANS_SERVER_KEY: 'SB-Mid-server-XmFoI8_j9MpEyaNvbE1-sQiN',\n  MIDTRANS_CLIENT_KEY: 'SB-Mid-client-ht5GrRu9A98pjHLR',\n  MIDTRANS_MERCHANT_ID: 'G485644100'\n};\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (CONFIG);\n\n//# sourceURL=webpack://celenganku-app/./server/global/config.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => __WEBPACK_DEFAULT_EXPORT__\n/* harmony export */ });\n/* harmony import */ var express__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! express */ \"express\");\n/* harmony import */ var express__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(express__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var multer__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! multer */ \"multer\");\n/* harmony import */ var multer__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(multer__WEBPACK_IMPORTED_MODULE_1__);\n/* harmony import */ var body_parser__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! body-parser */ \"body-parser\");\n/* harmony import */ var body_parser__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(body_parser__WEBPACK_IMPORTED_MODULE_2__);\n/* harmony import */ var _controllers_auth_controller__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../controllers/auth-controller */ \"./server/controllers/auth-controller.js\");\n\n\n\n\nvar upload = multer__WEBPACK_IMPORTED_MODULE_1___default()({\n  storage: multer__WEBPACK_IMPORTED_MODULE_1___default().memoryStorage(),\n  limits: {\n    fileSize: 5 * 1024 * 1024 // no larger than 5mb, you can change as needed.\n\n  }\n});\nvar appRoutes = express__WEBPACK_IMPORTED_MODULE_0___default().Router();\nappRoutes.use(body_parser__WEBPACK_IMPORTED_MODULE_2___default().json()); // appRoutes.use(AuthController.requireAuth)\n\nappRoutes.get('/token', _controllers_auth_controller__WEBPACK_IMPORTED_MODULE_3__.default.retrieveToken);\nappRoutes.post('/upload', upload.single('avatar'), _controllers_auth_controller__WEBPACK_IMPORTED_MODULE_3__.default.uploadFile);\nappRoutes.post('/delete', _controllers_auth_controller__WEBPACK_IMPORTED_MODULE_3__.default.deleteFile);\nappRoutes.use('/logout', _controllers_auth_controller__WEBPACK_IMPORTED_MODULE_3__.default.logout);\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (appRoutes);\n\n//# sourceURL=webpack://celenganku-app/./server/routes/app-routes.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => __WEBPACK_DEFAULT_EXPORT__\n/* harmony export */ });\n/* harmony import */ var express__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! express */ \"express\");\n/* harmony import */ var express__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(express__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var body_parser__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! body-parser */ \"body-parser\");\n/* harmony import */ var body_parser__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(body_parser__WEBPACK_IMPORTED_MODULE_1__);\n/* harmony import */ var _controllers_transaction_controller__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../controllers/transaction-controller */ \"./server/controllers/transaction-controller.js\");\n/* harmony import */ var _controllers_auth_controller__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../controllers/auth-controller */ \"./server/controllers/auth-controller.js\");\n\n\n\n\nvar transactionRoutes = express__WEBPACK_IMPORTED_MODULE_0___default().Router();\ntransactionRoutes.use(body_parser__WEBPACK_IMPORTED_MODULE_1___default().json()); // transactionRoutes.use(AuthController.requireAuth)\n\ntransactionRoutes.route('/create').post(_controllers_transaction_controller__WEBPACK_IMPORTED_MODULE_2__.default.createTransaction);\ntransactionRoutes.route('/:id').get(_controllers_transaction_controller__WEBPACK_IMPORTED_MODULE_2__.default.getTransactionById).patch(_controllers_transaction_controller__WEBPACK_IMPORTED_MODULE_2__.default.updateTransaction)[\"delete\"](_controllers_transaction_controller__WEBPACK_IMPORTED_MODULE_2__.default.deleteTransactionById);\ntransactionRoutes.route('/nisn/:id').get(_controllers_transaction_controller__WEBPACK_IMPORTED_MODULE_2__.default.getTransactionByNisn);\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (transactionRoutes);\n\n//# sourceURL=webpack://celenganku-app/./server/routes/transaction-routes.js?");
...
"use strict";
eval("module.exports = require(\"firebase/storage\");;\n\n//# sourceURL=webpack://celenganku-app/external_%22firebase/storage%22?");
...
"use strict";
eval("module.exports = require(\"multer\");;\n\n//# sourceURL=webpack://celenganku-app/external_%22multer%22?");
...
"use strict";
eval("module.exports = require(\"xhr2\");;\n\n//# sourceURL=webpack://celenganku-app/external_%22xhr2%22?");
