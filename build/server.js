...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => __WEBPACK_DEFAULT_EXPORT__\n/* harmony export */ });\n/* harmony import */ var dotenv__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! dotenv */ \"dotenv\");\n/* harmony import */ var dotenv__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(dotenv__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var atob__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! atob */ \"atob\");\n/* harmony import */ var atob__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(atob__WEBPACK_IMPORTED_MODULE_1__);\n/* harmony import */ var jsonwebtoken__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! jsonwebtoken */ \"jsonwebtoken\");\n/* harmony import */ var jsonwebtoken__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(jsonwebtoken__WEBPACK_IMPORTED_MODULE_2__);\n/* harmony import */ var _models_siswaModel__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../models/siswaModel */ \"./server/models/siswaModel.js\");\n/* harmony import */ var _siswaController__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./siswaController */ \"./server/controllers/siswaController.js\");\nfunction asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }\n\nfunction _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"next\", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"throw\", err); } _next(undefined); }); }; }\n\n/* eslint-disable consistent-return */\n\n\n\n\n\ndotenv__WEBPACK_IMPORTED_MODULE_0___default().config();\nvar maxAge = 3 * 24 * 60 * 60;\n\nvar createToken = function createToken(id) {\n  var role = 'user';\n\n  if (id.length < 10) {\n    role = 'admin';\n  }\n\n  var accessToken = jsonwebtoken__WEBPACK_IMPORTED_MODULE_2___default().sign({\n    id: id,\n    role: role\n  }, process.env.ACCESS_TOKEN_SECRET, {\n    expiresIn: process.env.ACCESS_EXPIRE_TIME\n  });\n  return accessToken;\n};\n\nvar authController = {\n  requireAuth: function requireAuth(req, res, next) {\n    var token = req.cookies.jwt;\n\n    if (token) {\n      jsonwebtoken__WEBPACK_IMPORTED_MODULE_2___default().verify(token, process.env.ACCESS_TOKEN_SECRET, function (err, decodedToken) {\n        if (err) {\n          console.log(err.message);\n          res.redirect('/login');\n        } else {\n          console.log(decodedToken);\n          next();\n        }\n      });\n    } else {\n      res.redirect('/login');\n    }\n  },\n  restrictTo: function restrictTo() {\n    for (var _len = arguments.length, roles = new Array(_len), _key = 0; _key < _len; _key++) {\n      roles[_key] = arguments[_key];\n    }\n\n    return function (req, res, next) {\n      if (!roles.includes(req.user.role)) {\n        res.status(401).json({\n          status: 'failed',\n          error: true,\n          message: 'You\\'re not allowed to do that action',\n          response: req.body\n        });\n      }\n\n      next();\n    };\n  },\n  login: function () {\n    var _login = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(req, res, next) {\n      var _req$body, nisn, password, account, token;\n\n      return regeneratorRuntime.wrap(function _callee$(_context) {\n        while (1) {\n          switch (_context.prev = _context.next) {\n            case 0:\n              _context.prev = 0;\n              _req$body = req.body, nisn = _req$body.nisn, password = _req$body.password;\n\n              if (!(!nisn || !password)) {\n                _context.next = 4;\n                break;\n              }\n\n              return _context.abrupt(\"return\", res.status(404).json({\n                status: 'failed',\n                error: true,\n                message: 'Please provide NISN, or password',\n                response: req.body\n              }));\n\n            case 4:\n              _context.next = 6;\n              return _models_siswaModel__WEBPACK_IMPORTED_MODULE_3__.default.akun.where('nisn', '==', nisn).where('password', '==', password).get();\n\n            case 6:\n              account = _context.sent;\n\n              if (account.empty) {\n                res.status(401).json({\n                  status: 'failed',\n                  error: true,\n                  message: 'Wrong NISN or Password',\n                  response: req.body\n                });\n              }\n\n              token = createToken(nisn);\n              req.body.password = undefined;\n              res.cookie('jwt', token, {\n                httpOnly: true,\n                maxAge: maxAge * 1000\n              });\n              res.status(200).json({\n                status: 'success',\n                error: false,\n                response: req.body\n              });\n              _context.next = 17;\n              break;\n\n            case 14:\n              _context.prev = 14;\n              _context.t0 = _context[\"catch\"](0);\n              next(_context.t0);\n\n            case 17:\n            case \"end\":\n              return _context.stop();\n          }\n        }\n      }, _callee, null, [[0, 14]]);\n    }));\n\n    function login(_x, _x2, _x3) {\n      return _login.apply(this, arguments);\n    }\n\n    return login;\n  }(),\n  register: function () {\n    var _register = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(req, res, next) {\n      var _yield$siswaControlle, nisn, token;\n\n      return regeneratorRuntime.wrap(function _callee2$(_context2) {\n        while (1) {\n          switch (_context2.prev = _context2.next) {\n            case 0:\n              _context2.next = 2;\n              return _siswaController__WEBPACK_IMPORTED_MODULE_4__.default.createAkunSiswa(req, res, next);\n\n            case 2:\n              _yield$siswaControlle = _context2.sent;\n              nisn = _yield$siswaControlle.nisn;\n              console.log(nisn);\n              token = createToken(nisn);\n              req.body.password = undefined;\n              res.cookie('jwt', token, {\n                httpOnly: true,\n                maxAge: maxAge * 1000\n              });\n              res.status(200).json({\n                status: 'success',\n                error: false,\n                response: req.body\n              });\n\n            case 9:\n            case \"end\":\n              return _context2.stop();\n          }\n        }\n      }, _callee2);\n    }));\n\n    function register(_x4, _x5, _x6) {\n      return _register.apply(this, arguments);\n    }\n\n    return register;\n  }(),\n  retrieveToken: function () {\n    var _retrieveToken = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(req, res, next) {\n      return regeneratorRuntime.wrap(function _callee3$(_context3) {\n        while (1) {\n          switch (_context3.prev = _context3.next) {\n            case 0:\n              res.status(200).json({\n                status: 'success',\n                error: false,\n                response: req.cookies.jwt\n              });\n\n            case 1:\n            case \"end\":\n              return _context3.stop();\n          }\n        }\n      }, _callee3);\n    }));\n\n    function retrieveToken(_x7, _x8, _x9) {\n      return _retrieveToken.apply(this, arguments);\n    }\n\n    return retrieveToken;\n  }(),\n  retrieveUser: function () {\n    var _retrieveUser = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(req, res, next) {\n      var cookiesToken, parsedToken;\n      return regeneratorRuntime.wrap(function _callee4$(_context4) {\n        while (1) {\n          switch (_context4.prev = _context4.next) {\n            case 0:\n              _context4.next = 2;\n              return req.cookies.jwt;\n\n            case 2:\n              cookiesToken = _context4.sent;\n              parsedToken = JSON.parse(atob__WEBPACK_IMPORTED_MODULE_1___default()(cookiesToken.split('.')[1]));\n              res.status(200).json({\n                status: 'success',\n                error: false,\n                response: parsedToken\n              });\n\n            case 5:\n            case \"end\":\n              return _context4.stop();\n          }\n        }\n      }, _callee4);\n    }));\n\n    function retrieveUser(_x10, _x11, _x12) {\n      return _retrieveUser.apply(this, arguments);\n    }\n\n    return retrieveUser;\n  }()\n};\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (authController);\n\n//# sourceURL=webpack://celenganku-app/./server/controllers/authController.js?");

/***/ }),

/***/ "./server/controllers/globalController.js":
/*!************************************************!*\
  !*** ./server/controllers/globalController.js ***!
  \************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => __WEBPACK_DEFAULT_EXPORT__\n/* harmony export */ });\n/* harmony import */ var express__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! express */ \"express\");\n/* harmony import */ var express__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(express__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var body_parser__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! body-parser */ \"body-parser\");\n/* harmony import */ var body_parser__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(body_parser__WEBPACK_IMPORTED_MODULE_1__);\n/* harmony import */ var _controllers_siswaController__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../controllers/siswaController */ \"./server/controllers/siswaController.js\");\n/* harmony import */ var _controllers_authController__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../controllers/authController */ \"./server/controllers/authController.js\");\n\n\n\n\nvar siswaRoutes = express__WEBPACK_IMPORTED_MODULE_0___default().Router();\nsiswaRoutes.use(body_parser__WEBPACK_IMPORTED_MODULE_1___default().json());\nsiswaRoutes.post('/login', _controllers_authController__WEBPACK_IMPORTED_MODULE_3__.default.login);\nsiswaRoutes.post('/register', _controllers_authController__WEBPACK_IMPORTED_MODULE_3__.default.register);\nsiswaRoutes.use(_controllers_authController__WEBPACK_IMPORTED_MODULE_3__.default.requireAuth);\nsiswaRoutes.route('/').get(_controllers_siswaController__WEBPACK_IMPORTED_MODULE_2__.default.getAllAkunSiswa);\nsiswaRoutes.route('/:id').get(_controllers_siswaController__WEBPACK_IMPORTED_MODULE_2__.default.getAkunSiswa).patch(_controllers_siswaController__WEBPACK_IMPORTED_MODULE_2__.default.updateAkunSiswa)[\"delete\"](_controllers_siswaController__WEBPACK_IMPORTED_MODULE_2__.default.deleteAkunSiswa);\nsiswaRoutes.route('/:id/profil').get(_controllers_siswaController__WEBPACK_IMPORTED_MODULE_2__.default.getProfilSiswa);\nsiswaRoutes.route('/:id/data').get(_controllers_siswaController__WEBPACK_IMPORTED_MODULE_2__.default.getDataSiswa);\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (siswaRoutes);\n\n//# sourceURL=webpack://celenganku-app/./server/routes/siswaRoutes.js?");
...
"use strict";
eval("module.exports = require(\"atob\");;\n\n//# sourceURL=webpack://celenganku-app/external_%22atob%22?");
